...
export const Icons = {
  ...
  Trending: () => {
    const currentPage = useSelector<RootState>(
      (state) => state.nav.currentPage
    );
    const id = 0;
    return (
      <svg
      ...
      >
        <path
          ...
          fill={currentPage === id ? "white" : "#5A698F"}
        />
      </svg>
    );
  },
  ...
  Dot: () => (
    <div className="rounded-full w-[0.1875rem] h-[0.1875rem] bg-white"></div>
  ),
};
